...
export default function LiveApplicationPage({
	...
	return (
		<>
			...
			<AvailableLink availableApplicationsWithUrl={availableApplicationsWithUrl}		/>
...
function AvailableLink({ availableApplicationsWithUrl }: { availableApplicationsWithUrl: LiveApplicationWithUrl[] }) {
